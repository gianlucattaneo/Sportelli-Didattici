...
public class Parser {
    ...
    public String ArraytoCSV(List<NodeList> lista){
        ...
        for(int i = 1; i <lista.size();i = i + 2){
            ...
            tmp1 = getTextValueX4(lista.get(i),"td");
    ...
    public List getTextValueX4(NodeList nodelist, String tag) {
        ...
        if (nodelist != null && nodelist.getLength() > 0) { // PRENDE I 4 TD PRESENTI
            lista.add(nodelist.item(0).getNodeValue());
            lista.add(nodelist.item(1).getNodeValue());
            lista.add(nodelist.item(2).getNodeValue());
            lista.add(nodelist.item(3).getNodeValue());
        }
        return lista;
    }
